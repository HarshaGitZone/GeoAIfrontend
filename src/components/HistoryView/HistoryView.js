...
//               <span className="sync-pulse">ACTIVE ANALYSIS</span>
//             </div>
            
//             <div className="snapshot-grid">
//               {snapshots.map((snap) => {
//                 // Use historyBundle for past, or 'data' for Present
...
//                 const isSelected = timeRange === snap.key || (snap.key === 'Today' && timeRange === 'Present');
...
//                       {/* This div uses CSS gradients to simulate land-cover based on actual scores */}
//                       <div 
//                         className="map-render" 
//                         style={{ 
//                           background: `linear-gradient(135deg, #1a472a ${snapData?.terrain?.nature_density}%, #334155 ${snapData?.terrain?.urban_density}%)` 
//                         }}
//                       >
//                         <div className="map-grid-overlay"></div>
//                         {snap.key === 'Today' && <div className="pulse-location-marker"></div>}
//                       </div>
//                     </div>
